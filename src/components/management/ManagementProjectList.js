...
import "./ManagementProjectList.css";
            ...
            <Navbar.Collapse id="naFaSistrixvbarScroll">
              ...
              <Navbar.Collapse className="justify-content-end">
                <Navbar.Brand className="text-light">
                  ...
                  <Link to={'/#action1'} style={{textDecoration: 'None', color:'white'}}>Sort/filter Project</Link>
                  </Button>
                </Navbar.Brand>
              </Navbar.Collapse>
            ...
            <tbody>
                ...
                {searchProjectList.length > 0 ? searchProjectList.map((x, index) => {
                    return (
                      <tr key={index}>
                        <td>{index + 1}</td>
                        <td>{x.project_manager_name }</td>
                        <td>{x.start_date}</td>
                        <td>{x.end_date}</td>
                        <td>{x.overall_status}</td>
                        <td>
...
export default ManagementProjectList;
